...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title title='Room Listings' subTitle='View, edit, and manage all listed rooms. Keep the information up-to-date to provide the best experience for the users.' align='left' font='outfit' />
        ...
        <table className='w-full'>
          <thead className='bg-gray-50'>
            <tr>
              ...
              <th className='py-3 px-4 text-gray-800 font-medium max-sm:hidden'>Amenities</th>
